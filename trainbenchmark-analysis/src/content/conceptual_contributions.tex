...
Note that $K_n$ can be substituted with $F_0$, 

furthermore, in the $i$ iteration, the algorithm connects $c^i$ clusters to the center which implicates $c^i \cdot (n-1)$ diagonals, and edges as well. Thus, modifying Equation \ref{eq:f1_version1}, we obtain:
