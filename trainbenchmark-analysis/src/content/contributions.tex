...
The \textsf{Schedule Generator} component and the related \textsf{Topologies} are entirely new features in the framework. Although the abstract \textsf{Generator} had to be extended to support different domains in the framework.
