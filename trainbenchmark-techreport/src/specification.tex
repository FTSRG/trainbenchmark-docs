...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item  \emph{SignalNeighbor:} Disconnect \emph{exit} references of randomly selected invalid \emph{routes}, resulting in a structure where the constraint must not be hold for the actual route (\figref{fig:trainbenchmark-transformation-xform-signalneighbor}).
