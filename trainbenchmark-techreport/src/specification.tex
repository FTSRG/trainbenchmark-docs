...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.6\textwidth}
                \centering
                \includegraphics[scale=0.4]{figures/transformation-user-switchset}
                \caption{\textsf{SwitchSet}}
                \label{fig:transformation-user-switchset}
        \end{subfigure}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \emph{RouteSensor:} The \emph{definedBy} edges between the randomly selected \emph{routes} and their \emph{first} connected \emph{sensor} are removed (at most one edge for each route, see~\figref{fig:transformation-user-routesensor}).
...
\begin{figure}
        ...
        \begin{subfigure}[b]{\textwidth}
        		\centering
                \includegraphics[scale=0.3]{figures/transformation-repair-poslength}
                \caption{\textsf{PosLength}}
        ...
        \begin{subfigure}[b]{\textwidth}
                \centering
                \includegraphics[scale=0.3]{figures/transformation-repair-routesensor}
                \caption{\textsf{RouteSensor}}
        ...
        \begin{subfigure}[b]{\textwidth}
                \centering
                \includegraphics[scale=0.3]{figures/transformation-repair-semaphoreneighbor}
                \caption{\textsf{SemaphoreNeighbor}}
        ...
        \begin{subfigure}[b]{\textwidth}
                \centering
                \includegraphics[scale=0.3]{figures/transformation-repair-switchsensor}
                \caption{\textsf{SwitchSensor}}
        ...
        \begin{subfigure}[b]{\textwidth}
                \centering
                \includegraphics[scale=0.3]{figures/transformation-repair-switchset}
                \caption{\textsf{SwitchSet}}
