...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \emph{PosLength:} Random elements selected from the set of invalid elements, and their values are negated: updated to $-1*(\mathit{oldValue}-1)$ \figref{fig:trainbenchmark-transformation-xform-poslength}.
