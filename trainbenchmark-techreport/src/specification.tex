...
\begin{table}[h]
	...
	\multicolumn{1}{ |l| }{\bf ConnectedSegments} & ...    & ...      & ...    & ...      \\ \hline
	...
	\multicolumn{1}{ |l| }{\bf SwitchSet}         & ...    & ...      & ...    & ...      \\ \hline
	\end{tabular}
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.7\textwidth}
                \centering
                \includegraphics[scale=0.4]{figures/transformation-user-connectedsegments}
                \caption{\textsf{ConnectedSegments}}
                \label{fig:transformation-user-connectedsegments}
        \end{subfigure}
        ~
