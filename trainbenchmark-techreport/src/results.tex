...
\benchmarkresult{series_DetEdit_1_SemaphoreNeighbor}{Series of edit times for the \textsf{SemaphoreNeighbor} query in the \textsf{User} scenario.}
...
\benchmarkresult{series_DetCheck_1_SemaphoreNeighbor}{Series of incremental revalidation times for the \textsf{SemaphoreNeighbor} query in the \textsf{User} scenario.}
