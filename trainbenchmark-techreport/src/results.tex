...
\benchmarkresult{User_ReadPCheck0_PosLength}{Batch validation times for the \textsf{PosLength} query in the \textsf{User} scenario.}
\benchmarkresult{User_ReadPCheck0_RouteSensor}{Batch validation times for the \textsf{RouteSensor} query in the \textsf{User} scenario.}
\benchmarkresult{User_ReadPCheck0_SignalNeighbor}{Batch validation times for the \textsf{SignalNeighbor} query in the \textsf{User} scenario.}
\benchmarkresult{User_ReadPCheck0_SwitchSensor}{Batch validation times for the \textsf{SwitchSensor} query in the \textsf{User} scenario.}

\subsection{Batch Validation (XForm Scenario)}

\benchmarkresult{XForm_ReadPCheck0_PosLength}{Batch validation times for the \textsf{PosLength} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_ReadPCheck0_RouteSensor}{Batch validation times for the \textsf{RouteSensor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_ReadPCheck0_SignalNeighbor}{Batch validation times for the \textsf{SignalNeighbor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_ReadPCheck0_SwitchSensor}{Batch validation times for the \textsf{SwitchSensor} query in the \textsf{XForm} scenario.}

\subsection{Revalidation (User Scenario)}

\benchmarkresult{User_SumModifyPSumReCheck_PosLength}{Revalidation times for the \textsf{PosLength} query.}
\benchmarkresult{User_SumModifyPSumReCheck_RouteSensor}{Revalidation times for the \textsf{RouteSensor} query.}
\benchmarkresult{User_SumModifyPSumReCheck_SignalNeighbor}{Revalidation times for the \textsf{SignalNeighbor} query.}
\benchmarkresult{User_SumModifyPSumReCheck_SwitchSensor}{Revalidation times for the \textsf{SwitchSensor} query.}

\subsection{Revalidation (XForm Scenario)}

\benchmarkresult{XForm_SumModifyPSumReCheck_PosLength}{Revalidation times for the \textsf{PosLength} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumModifyPSumReCheck_RouteSensor}{Revalidation times for the \textsf{RouteSensor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumModifyPSumReCheck_SignalNeighbor}{Revalidation times for the \textsf{SignalNeighbor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumModifyPSumReCheck_SwitchSensor}{Revalidation times for the \textsf{SwitchSensor} query in the \textsf{XForm} scenario.}

\subsection{Total Time (User Scenario)}

\benchmarkresult{User_SumTime_PosLength}{Total time for the \textsf{PosLength} query in the \textsf{User} scenario.}
\benchmarkresult{User_SumTime_RouteSensor}{Total time for the \textsf{RouteSensor} query in the \textsf{User} scenario.}
\benchmarkresult{User_SumTime_SignalNeighbor}{Total time for the \textsf{SignalNeighbor} query in the \textsf{User} scenario.}
\benchmarkresult{User_SumTime_SwitchSensor}{Total time for the \textsf{SwitchSensor} query in the \textsf{User} scenario.}

\subsection{Total Time (XForm Scenario)}

\benchmarkresult{XForm_SumTime_PosLength}{Total time for the \textsf{PosLength} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumTime_RouteSensor}{Total time for the \textsf{RouteSensor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumTime_SignalNeighbor}{Total time for the \textsf{SignalNeighbor} query in the \textsf{XForm} scenario.}
\benchmarkresult{XForm_SumTime_SwitchSensor}{Total time for the \textsf{SwitchSensor} query in the \textsf{XForm} scenario.}

\subsection{Memory Usage (User Scenario)}

\benchmarkresult{User_Memory_PosLength}{Memory consumption of the \textsf{PosLength} query in the \textsf{User} scenario.}
\benchmarkresult{User_Memory_RouteSensor}{Memory consumption of the \textsf{RouteSensor} query in the \textsf{User} scenario.}
\benchmarkresult{User_Memory_SignalNeighbor}{Memory consumption of the \textsf{SignalNeighbor} query in the \textsf{User} scenario.}
\benchmarkresult{User_Memory_SwitchSensor}{Memory consumption of the \textsf{SwitchSensor} query in the \textsf{User} scenario.}

\subsection{Memory Usage (XForm Scenario)}

\benchmarkresult{User_Memory_PosLength}{Memory consumption of the \textsf{PosLength} query in the \textsf{XForm} scenario.}
\benchmarkresult{User_Memory_RouteSensor}{Memory consumption of the \textsf{RouteSensor} query in the \textsf{XForm} scenario.}
\benchmarkresult{User_Memory_SignalNeighbor}{Memory consumption of the \textsf{SignalNeighbor} query in the \textsf{XForm} scenario.}
\benchmarkresult{User_Memory_SwitchSensor}{Memory consumption of the \textsf{SwitchSensor} query in the \textsf{XForm} scenario.}
