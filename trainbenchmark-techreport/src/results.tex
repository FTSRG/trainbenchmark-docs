...
%\benchmarkresult{User_ReadPCheck0_PosLength}{Batch Validation - PosLength}
%\benchmarkresult{User_ReadPCheck0_SwitchSensor}{Batch Validation - SwitchSensor}
%\benchmarkresult{User_ReadPCheck0_RouteSensor}{Batch Validation - RouteSensor}
%\benchmarkresult{User_ReadPCheck0_SignalNeighbor}{Batch Validation - SignalNeighbor}

\benchmarkresult{XForm_ReadPCheck0_PosLength}{Batch Validation - PosLength}
\benchmarkresult{XForm_ReadPCheck0_SwitchSensor}{Batch Validation - SwitchSensor}
\benchmarkresult{XForm_ReadPCheck0_RouteSensor}{Batch Validation - RouteSensor}
\benchmarkresult{XForm_ReadPCheck0_SignalNeighbor}{Batch Validation - SignalNeighbor}
