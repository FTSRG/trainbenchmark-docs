...
\newcommand{\eiq}{\textsc{EMF-IncQuery}\@\xspace}
\newcommand{\iqd}{\textsc{IncQuery-D}\@\xspace}
\let\codeCap\texttt
...
\newcommand{\forallqueries}[1]{\foreach \n in {PosLength,RouteSensor,SemaphoreNeighbor,SwitchSensor}{#1}}
...
\centering{0.10} & \centering{Sixth draft - revisions in scenarios and transformations} & \centering{15 March 2015} \tabularnewline\hline
\end{tabular}
