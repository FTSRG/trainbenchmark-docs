...
\centering{0.8} & \centering{Fourth draft - results complete, analysis needs rework} & \centering{10 April 2014} \tabularnewline
\hline
\end{tabular}
