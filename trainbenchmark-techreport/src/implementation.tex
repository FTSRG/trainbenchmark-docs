...
implementation by Ed Willink from the Eclipse OCL project.
%, the usage of Impact Analyzer by Axel Uhl from the Impact Analyzer developer team. 
The graph patterns were written by the developers of \incquery{}.
